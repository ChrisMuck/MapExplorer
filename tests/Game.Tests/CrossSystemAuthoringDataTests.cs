...
internal sealed class CrossSystemAuthoringDataTests
{
    ...
    private static void TargetDefinitionsLoadAndValidateAgainstCurrentContent()
    {
        var authoring = CrossSystemAuthoringDataLoader.LoadFromJson(new[]
        {
            ...
            """{ "documentType":"situation-definitions", "schemaVersion":2, "items":[{ "id":"situation-test-request", "kind":"request", "possibleSourceKinds":["individual"], "urgencyLabels":["soon"], "responseOptions":[{ "id":"accept", "actionTag":"assist" }], "resolutionTags":["help-provided"] }, { "id":"situation-request-help-with-crossing", "kind":"request", "possibleSourceKinds":["faction"], "urgencyLabels":["soon"], "responseOptions":[{ "id":"accept", "actionTag":"assist" }], "resolutionTags":["help-provided"] }, { "id":"situation-investigate-disturbance", "kind":"warning", "possibleSourceKinds":["world"], "urgencyLabels":["soon"], "responseOptions":[{ "id":"investigate", "actionTag":"investigate" }], "resolutionTags":["resolved"] }, { "id":"situation-investigate-opened-seal", "kind":"warning", "possibleSourceKinds":["world"], "urgencyLabels":["soon"], "responseOptions":[{ "id":"contain", "actionTag":"contain" }], "resolutionTags":["resolved"] }, { "id":"situation-route-use-changed", "kind":"notice", "possibleSourceKinds":["world"], "urgencyLabels":["soon"], "responseOptions":[{ "id":"coordinate", "actionTag":"organize-help" }], "resolutionTags":["coordinated"] }, { "id":"situation-neutral-local-crisis", "kind":"crisis", "possibleSourceKinds":["world"], "urgencyLabels":["soon"], "responseOptions":[{ "id":"investigate", "actionTag":"investigate" }], "resolutionTags":["resolved"] }] }""",
